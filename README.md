# Bem-vindo, eu sou Eduardo Fabrício
## Eduardo Fabrício Moreira Souza
...
### 📱 IFAMAP — IFAM
Aplicativo desenvolvido em Flutter durante minha formação técnica no IFAM, criado para auxiliar estudantes na localização de ambientes dentro do campus de São Gabriel da Cachoeira.

Participei das etapas de levantamento de requisitos, prototipação, desenvolvimento e testes.

### LLIA
Projeto educacional desenvolvido em equipe, com foco em acessibilidade e inclusão. Participei do desenvolvimento da aplicação e da construção da solução junto à equipe.
